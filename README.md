# 🔬 ScienceDialog（サイエンスダイアログ）

小学4年生の理科学習における「予想」と「考察」を支援するAI対話型Webアプリケーションです。ソクラテス問答法とAI（OpenAI API）を組み合わせ、子どもに寄り添いながら科学的思考力を育てます。
...
### 何ができるアプリか
ScienceDialoは、小学校理科の学習過程において、子ども達が**経験から根拠ある予想を作り、実験結果を基に考察を深める**のをAIが支援します。

- 📝 **予想段階**: 子どもの経験から「なぜそう思うのか」という根拠を引き出す
- 🔍 **実験段階**: 児童が実験を実施
- 💭 **考察段階**: 実験結果と予想を比較しながら、新しい理解を形成
- 📋 **記録**: 全ての対話と学習過程をログに記録

### 教育的アプローチ
**ソクラテス問答法** による対話で、子ども自身の気づきと発見を大切にします。
...
- **話した順序を尊重**
  - 経験→予想の順序でも、予想→経験の順序でもOK
  - 子どもが自然に話した流れをそのまま活かす
- **書き言葉への自然な変換**
  - 口語（「〜って」「〜だから」）→ 書き言葉（「〜と」「〜から」）
  - ただし、子どもらしさは残す

**要約例（子どもの話し方によって柔軟に変わる）**:
- 「夏の日にタイヤがパンパンになった気がする。だから、あたためると体せきが大きくなると思う。」
- 「やかんでお湯をわかしたとき、ボコボコしてきて湯気が出た。温度はどんどん上がっていったけど、100℃くらいで止まった気がする。」
- 「お風呂に入ったとき、上の方はあたたかいけど、下の方はつめたかった。だから水は上の方からあたたまっていくと思う。」
